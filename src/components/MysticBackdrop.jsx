...
// A mystical night backdrop rendered to a canvas — deep indigo space, drifting
// nebula glows, aurora veils, twinkling stars, a soft glowing orb, and rising
// motes of light. Self-contained (no external images), gently animated, and it
// stands still for people who prefer reduced motion.
...
export default function MysticBackdrop() {
  ...
  useEffect(() => {
    ...
    const draw = (t) => {
      ...
      // a soft glowing orb, like a quiet moon
      const ox = w * 0.78
      const oy = h * 0.2
      const or = h * 0.055
      ctx.globalCompositeOperation = 'screen'
    ...
    if (reduced) {
      draw(2.5) // one calm, static frame
    } else {
