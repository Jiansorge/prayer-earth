...
// and dust motes in the light. Self-contained and still for reduced-motion.
...
export default function TempleBackdrop() {
  ...
  useEffect(() => {
    ...
    const draw = (t) => {
      ...
      // warm light from behind the columns (a doorway of quiet fire)
      ...
      // central arch over the middle columns
      const ax = w * 0.5
      const ar = w * 0.13
      ctx.beginPath()
      ctx.moveTo(ax - ar, h)
