export default   {
    ...
    prayers: [
      ...
      },
      {
        ...
        loop: true,
        phrases: [
          { t: 'Namo Ksitigarbha Bodhisattva', e: 'Homage to Ksitigarbha Bodhisattva, the one who vows to save all beings.' },
          { t: 'Namo Ksitigarbha Bodhisattva', e: 'Homage to Ksitigarbha Bodhisattva, the one who vows to save all beings.' },
          { t: 'Namo Ksitigarbha Bodhisattva', e: 'Homage to Ksitigarbha Bodhisattva, the one who vows to save all beings.' }
        ],
      ...
      },
      {
        ...
        loop: true,
        phrases: [
          { t: 'Sabbe sattā bhavantu sukhitattā', e: 'May all beings be happy and at ease.' },
          { t: 'Sabbe sattā arogā hontu', e: 'May all beings be healthy and whole.' },
          { t: 'Sabbe sattā sukhitā hontu', e: 'May all beings be truly happy.' },
          { t: 'Sabbe sattā khemā hontu', e: 'May all beings be safe from harm.' },
          { t: 'Sabbe sattā bhadrāni passantu', e: 'May all beings see what is good and auspicious.' }
        ],
      ...
      },
      {
        ...
        lang: 'en',
        langLabel: 'English \u00b7 Tibetan text below \u00b7 21 verses',
        loop: true,
        phrases: [
          { t: 'Homage to Tārā, swift and valiant; homage to Tuttārā, who banishes fear; homage to Turā, who fulfils every need. With svāhā we offer honour and praise.', s: 'ཕྱག་འཚལ་ཏཱ་རེ་མྱུར་མ་དཔའ་མོ། ཏུཏྟཱ་ར་ཡིས་འཇིགས་པ་སེལ་མ། ཏུ་རེས་དོན་ཀུན་སྦྱིན་པས་སྒྲོལ་མ། སྭཱ་ཧཱའི་ཡི་གེ་ཁྱོད་ལ་འདུད་དོ།' },
          { t: 'Homage to Tārā, swift and valiant, whose glance flashes like flares of lightning, born on the heart of a blossoming lotus that rose from the tears of the Triple World’s Lord.', s: 'ཕྱག་འཚལ་སྒྲོལ་མ་མྱུར་མ་དཔའ་མོ། སྤྱན་ནི་སྐད་ཅིག་གློག་དང་འདྲ་མ། འཇིག་རྟེན་གསུམ་མགོན་ཆུ་སྐྱེས་ཞལ་གྱི་གེ་སར་བྱེ་བ་ལས་ནི་བྱུང་མ།' },
          { t: 'Homage to the one whose countenance is a hundred full moons gathered in autumn, smiling and glowing with brilliant radiance, like a thousand stars clustered, ablaze.', s: 'ཕྱག་འཚལ་སྟོན་ཀའི་ཟླ་བ་ཀུན་ཏུ། གང་བ་བརྒྱ་ནི་བརྩེགས་པའི་ཞལ་མ། སྐར་མ་སྟོང་ཕྲག་ཚོགས་པ་རྣམས་ཀྱི་རབ་ཏུ་ཕྱེ་བའི་འོད་རབ་འབར་མ།' },
          { t: 'Homage, golden lady, whose lotus-hand is graced with a blue water-born flower. You embody generosity, diligence, endurance, serenity, patience and meditation.', s: 'ཕྱག་འཚལ་སེར་སྔོ་ཆུ་ནས་སྐྱེས་ཀྱི་པདྨས་ཕྱག་ནི་རྣམ་པར་བརྒྱན་མ། སྦྱིན་པ་བརྩོན་འགྲུས་དཀའ་ཐུབ་ཞི་བ་བཟོད་པ་བསམ་གཏན་སྤྱོད་ཡུལ་ཉིད་མ།' },
          { t: 'Homage to the one whose victories are endless, a jewel on the great Tathāgata’s crown. You are well served by the heirs of the Victors, those who have accomplished all the perfections.', s: 'ཕྱག་འཚལ་དེ་བཞིན་གཤེགས་པའི་གཙུག་ཏོར། མཐའ་ཡས་རྣམ་པར་རྒྱལ་བ་སྤྱོད་མ། མ་ལུས་པ་རོལ་ཕྱིན་པ་ཐོབ་པའི་རྒྱལ་བའི་སྲས་ཀྱིས་ཤིན་ཏུ་བསྟེན་མ།' },
          { t: 'Homage to the one who, with tuttāre and hūṃ, fills the desire realms unto the ends of space. You trample underfoot the seven worlds, and have the strength to summon all.', s: 'ཕྱག་འཚལ་ཏུཏྟཱ་ར་ཧཱུྃ་ཡི་གེ་འདོད་དང་ཕྱོགས་དང་ནམ་མཁའ་གང་མ། འཇིག་རྟེན་བདུན་པོ་ཞབས་ཀྱིས་མནན་ཏེ་ལུས་པ་མེད་པར་འགུགས་པར་ནུས་མ།' },
          { t: 'Homage to the one praised by Indra, Agni, Brahmā, Maruts and Śiva. All the hosts of bhūtas, vetālas, gandharvas and yakṣas pay tribute to you.', s: 'ཕྱག་འཚལ་བརྒྱ་བྱིན་མེ་ལྷ་ཚངས་པ། རླུང་ལྷ་སྣ་ཚོགས་དབང་ཕྱུག་མཆོད་མ། འབྱུང་པོ་རོ་ལངས་དྲི་ཟ་རྣམས་དང་གནོད་སྦྱིན་ཚོགས་ཀྱིས་མདུན་ནས་བསྟོད་མ།' },
          { t: 'Homage to the one who, with traṭ and phaṭ, crushes the enemies’ magic diagrams to dust. With right leg bent in and left leg extended, shining, you tread amidst a turbulent blaze.', s: 'ཕྱག་འཚལ་ཏྲཊ་ཅེས་བྱ་དང་ཕཊ་ཀྱིས་ཕ་རོལ་འཕྲུལ་འཁོར་རབ་ཏུ་འཇོམས་མ། ཡང་བསྐུམ་གཡོན་བརྐྱང་ཞབས་ཀྱིས་མནན་ཏེ་མེ་འབར་འཁྲུག་པ་ཤིན་ཏུ་འབར་མ།' },
          { t: 'Homage to Ture, the fearsome lady, destroyer of the most powerful demons. With a lotus-face and a deep-furrowed brow, you are the slayer of each and every foe.', s: 'ཕྱག་འཚལ་ཏུ་རེ་འཇིགས་པ་ཆེན་པོས་བདུད་ཀྱི་དཔའ་བོ་རྣམ་པར་འཇོམས་མ། ཆུ་སྐྱེས་ཞལ་ནི་ཁྲོ་གཉེར་ལྡན་མཛད་དགྲ་བོ་ཐམས་ཅད་མ་ལུས་གསོད་མ།' },
          { t: 'Homage to the one whose fingers grace her heart and display the Three Jewels mudrā. You are graced by wheels adorning every direction, with dazzling radiance that overwhelms all.', s: 'ཕྱག་འཚལ་དཀོན་མཆོག་གསུམ་མཚོན་ཕྱག་རྒྱའི་སོར་མོས་ཐུགས་ཀར་རྣམ་པར་བརྒྱན་མ། མ་ལུས་ཕྱོགས་ཀྱི་འཁོར་ལོས་བརྒྱན་པའི་རང་གི་འོད་ཀྱི་ཚོགས་རྣམས་འཁྲུག་མ།' },
          { t: 'Homage to the one, supremely joyous, whose splendorous crown spreads garlands of light. Smiling and laughing, with tuttāre you bring demons and worlds under control.', s: 'ཕྱག་འཚལ་རབ་ཏུ་དགའ་བ་བརྗིད་པའི་དབུ་རྒྱན་འོད་ཀྱི་ཕྲེང་བ་སྤེལ་མ། བཞད་པ་རབ་བཞད་ཏུཏྟཱ་ར་ཡིས་བདུད་དང་འཇིག་རྟེན་དབང་དུ་མཛད་མ།' },
          { t: 'Homage to the one who can summon the hosts of earthly guardians. Your frown quivers, and the syllable hūṃ delivers us all from every misfortune.', s: 'ཕྱག་འཚལ་ས་གཞི་སྐྱོང་བའི་ཚོགས་རྣམས་ཐམས་ཅད་འགུགས་པར་ནུས་པ་ཉིད་མ། ཁྲོ་གཉེར་གཡོ་བའི་ཡི་གེ་ཧཱུྃ་གིས་ཕོངས་པ་ཐམས་ཅད་རྣམ་པར་སྒྲོལ་མ།' },
          { t: 'Homage to the one so brightly adorned, who has a sliver of moon for a crown. Your locks are graced by Amitābha, whose gleaming rays stream forever forth.', s: 'ཕྱག་འཚལ་ཟླ་བའི་དུམ་བུའི་དབུ་རྒྱན་བརྒྱན་པ་ཐམས་ཅད་ཤིན་ཏུ་འབར་མ། རལ་པའི་ཁྲོད་ན་འོད་དཔག་མེད་ལས་རྟག་པར་ཤིན་ཏུ་འོད་རབ་མཛད་མ།' },
          { t: 'Homage to the one in a blazing halo of flames, all-consuming, apocalyptic. Your right leg stretched out and left leg bent inward, the whirl of enemies blissfully crushing.', s: 'ཕྱག་འཚལ་བསཐལ་པ་ཐ་མའི་མེ་ལྟར་འབར་བའི་ཕྲེང་བའི་དབུས་ན་གནས་མ། ཡང་བརྐང་གཡོན་བསྐུམ་ཀུན་ནས་བསྐོར་དགའི་དགྲ་ཡི་དཔུང་ནི་རྣམ་པར་འཇོམས་མ།' },
          { t: 'Homage to the one who strikes the ground with her palms and stamps her feet. Your brow deeply furrowed, with hūṃ you smash the seven netherworlds to nothing but dust.', s: 'ཕྱག་འཚལ་ས་གཞིའི་ངོས་ལ་ཕྱག་གི་མཐིལ་གྱིས་བསྣུན་ཅིང་ཞབས་ཀྱིས་བརྡུང་མ། ཁྲོ་གཉེར་ཅན་མཛད་ཡི་གེ་ཧཱུྃ་གིས་རིམ་པ་བདུན་པོ་རྣམས་ནི་འགེམས་མ།' },
          { t: 'Homage to the one, blissful, gracious and tranquil, whose domain is the peace of nirvāṇa. With oṃ and svāhā in perfect union, you destroy every terrible evil.', s: 'ཕྱག་འཚལ་བདེ་མ་དགེ་མ་ཞི་མ་མྱ་ངན་འདས་ཞི་སྤྱོད་ཡུལ་ཉིད་མ། སྭཱ་ཧཱ་ཨོཾ་དང་ཡང་དག་ལྡན་པས་སྡིག་པ་ཆེན་པོ་འཇོམས་པ་ཉིད་མ།' },
          { t: 'Homage to the one immersed in rapture, who shatters the bodies of all foes. You manifest from the wisdom-syllable hūṃ, and display each of your mantra’s ten syllables.', s: 'ཕྱག་འཚལ་ཀུན་ནས་བསྐོར་རབ་དགའ་བའི་དགྲ་ཡི་ལུས་ནི་རབ་ཏུ་འགེམས་མ། ཡི་གེ་བཅུ་པའི་ངག་ནི་བཀོད་པའི་རིག་པ་ཧཱུྃ་ལས་སྒྲོལ་མ་ཉིད་མ།' },
          { t: 'Homage to Ture, her feet stomping boldly, formed from the seed of the syllable hūṃ. The mountains of Meru, Mandara and Vindhya, and all the three worlds, you cause to quake.', s: 'ཕྱག་འཚལ་ཏུ་རེའི་ཞབས་ནི་བརྡབས་པས་ཧཱུྃ་གི་རྣམ་པའི་ས་བོན་ཉིད་མ། རི་རབ་མནྡ་ར་དང་འབིགས་བྱེད་འཇིག་རྟེན་གསུམ་རྣམས་གཡོ་བ་ཉིད་མ།' },
          { t: 'Homage to the one who holds in her hand a deer-marked moon like a divine lake. With tāra twice and then with phaṭ, you totally cleanse all of the poisons.', s: 'ཕྱག་འཚལ་ལྷ་ཡི་མཚོ་ཡི་རྣམ་པའི་རི་དྭགས་རྟགས་ཅན་ཕྱག་ན་བསྣམས་མ། ཏཱ་ར་གཉིས་བརྗོད་ཕཊ་ཀྱི་ཡི་གེས་དུག་རྣམས་མ་ལུས་པར་ནི་སེལ་མ།' },
          { t: 'Homage to the one honoured by kings of hosts divine, gods and kiṃnaras. Clad in your armour of joy and splendour, you clear away nightmares and soothe away strife.', s: 'ཕྱག་འཚལ་ལྷ་ཡི་ཚོགས་རྣམས་རྒྱལ་པོ་ལྷ་དང་མི་འམ་ཅི་ཡིས་བསྟེན་མ། ཀུན་ནས་གོ་ཆ་དགའ་བ་བརྗིད་ཀྱི་རྩོད་དང་རྨི་ལམ་ངན་པ་སེལ་མ།' },
          { t: 'Homage to the one whose eyes shine with lustre, bright with the fullness of the sun and moon. With twice-uttered hara and then with tuttāre you pacify even the cruelest of diseases.', s: 'ཕྱག་འཚལ་ཉི་མ་ཟླ་བ་རྒྱས་པའི་སྤྱན་གཉིས་པོ་ལ་འོད་རབ་གསལ་མ། ཧ་ར་གཉིས་བརྗོད་ཏུཏྟཱ་ར་ཡིས་ཤིན་ཏུ་དྲག་པོའི་རིམས་ནད་སེལ་མ།' },
          { t: 'Homage to the one with the power to free, who puts forth the realities as a set of three. Supreme Ture, you completely destroy the hordes of grahas, vetālas and yakṣas.', s: 'ཕྱག་འཚལ་དེ་ཉིད་གསུམ་རྣམས་བཀོད་པས་ཞི་བའི་མཐུ་དང་ཡང་དག་ལྡན་མ། གདོན་དང་རོ་ལངས་གནོད་སྦྱིན་ཚོགས་རྣམས་འཇོམས་པ་ཏུ་རེ་རབ་མཆོག་ཉིད་མ།' }
        ],
